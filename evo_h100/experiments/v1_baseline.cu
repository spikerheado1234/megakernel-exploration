// v1_baseline: Forward-only copy of tk_evoattention.cu.
// Used as a baseline to confirm the experimental harness produces numbers
// that match the production binary.
